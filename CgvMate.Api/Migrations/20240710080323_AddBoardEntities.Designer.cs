...
namespace CgvMate.Api.Migrations
{
    ...
    [Migration("20240710080323_AddBoardEntities")]
    partial class AddBoardEntities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CgvMate.Api.Entites.Board", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CgvMate.Api.Entites.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CgvMate.Api.Entites.Post", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CgvMate.Api.Entites.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CgvMate.Api.Entites.Comment", b =>
                {
                    b.HasOne("CgvMate.Api.Entites.Comment", "ParentComment")
                        .WithMany("Children")
                        .HasForeignKey("ParentCommentId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("CgvMate.Api.Entites.Post", "Post")
                        .WithMany("Comments")
                        .HasForeignKey("PostId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CgvMate.Api.Entites.User", "User")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("CgvMate.Api.Entites.Post", b =>
                {
                    b.HasOne("CgvMate.Api.Entites.Board", "Board")
                        .WithMany("Posts")
